...
const STORAGE_KEY = "tac-calc-lang";

const DICT = {
	fr: {
		"app.title": "Taux de couverture d'encre (TAC)",
		"app.tagline": "Analyse un PDF print (CMJN + tons directs) et calcule la couverture d'encre par page. <strong>Le fichier reste dans votre navigateur</strong> — aucun upload, aucun serveur, ça fonctionne hors-ligne après le premier chargement.",
		...
		"report.footerNote": "Rapport généré par TAC-calc — 100% navigateur, aucune donnée envoyée sur un serveur.",
	},
	en: {
		"app.title": "Ink coverage rate (TAC)",
		"app.tagline": "Analyzes a print PDF (CMYK + spot colors) and calculates ink coverage per page. <strong>The file stays in your browser</strong> — no upload, no server, works offline after the first load.",
		...
		"report.footerNote": "Report generated by TAC-calc — 100% browser-based, no data sent to a server.",
	},
};
